...
function qtDefaultPermissionsForRole($role) {
	...
	if ($role === 'division_manager') {
		return ['timecards', 'pto', 'employee_board', 'sop_board', 'employee_card', 'marketplace_community', 'email_center', 'report_editing', 'user_admin', 'ai_quickstart'];
	}
	if ($role === 'sales') {
		return ['timecards', 'employee_card', 'marketplace_community', 'ai_quickstart'];
	}
	return ['timecards', 'employee_card', 'ai_quickstart'];
}
...
function qtRoleCapabilities($role) {
	...
	$map = [
		...
		'sales' => [
			...
			'messages', 'invoices', 'reports', 'leads', 'ai_quickstart',
		],
		'division_manager' => [
			...
			'timecards', 'pto', 'employee_board', 'employee_card', 'marketplace_community', 'email_center', 'report_editing',
			'ai_quickstart',
		],
		'general_manager' => ['all'],
	];
