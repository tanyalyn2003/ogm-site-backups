...
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . 'pushover.php';
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . 'meta-messaging.php';
...
function adminStartSession() {
  ...
  $config = adminConfig();
  session_name((string) ($config['session_name'] ?? 'ogm_sales_admin'));
